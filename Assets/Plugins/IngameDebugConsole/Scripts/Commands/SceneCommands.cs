...
namespace IngameDebugConsole.Commands
{
	...
	{
		[ConsoleMethod( "scene.load", "Loads a scene" ), Preserve]
		...
		[ConsoleMethod( "scene.loadasync", "Loads a scene asynchronously" ), Preserve]
		...
		[ConsoleMethod( "scene.unload", "Unloads a scene" ), Preserve]
		public static void UnloadScene( string sceneName )
		{
			SceneManager.UnloadSceneAsync( sceneName );
		}

		[ConsoleMethod( "scene.restart", "Restarts the active scene" ), Preserve]
